...
//  */
// public class FlutterLocalNotificationsPlugin implements MethodCallHandler, PluginRegistry.NewIntentListener, ViewDestroyListener {
...
//         // FROM ALARMMANAGER
//         // actionManagerPluginChannel is the channel responsible for receiving the following messages
//         // from the main Flutter app:
//         // - "AlarmService.start"
//         // - "Alarm.oneShotAt"
//         // - "Alarm.periodic"
//         // - "Alarm.cancel"
//         final MethodChannel actionManagerPluginChannel =
//             new MethodChannel(
//                 registrar.messenger(),
//                 "plugins.flutter.io/android_action_manager",
...
//             new MethodChannel(
//                 registrar.messenger(),
//                 "plugins.flutter.io/android_action_manager_background",
//                 JSONMethodCodec.INSTANCE);
...
//         actionManagerPluginChannel.setMethodCallHandler(plugin);
...
//         //                    notice.
//         ActionService.setBackgroundChannel(backgroundCallbackChannel);
//     }
...
//                     // method channels.
//                     ActionService.setCallbackDispatcher(mContext, callbackHandle);
//                     ActionService.startBackgroundIsolate(mContext, callbackHandle);
//                     break;
//                 case "ActionService.initialized":
...
//       return ActionService.setBackgroundFlutterView(nativeView);
//     }
// }
